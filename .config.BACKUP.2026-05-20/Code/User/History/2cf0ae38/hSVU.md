...
- Bracket matching
- smart autocompled in line - default hiden
- text search in file and global - default hiden

### 4.3 Popup File Explorer

Ventana emergente (popup) independiente para navegación de archivos, activada por atajo de teclado (ej. `Ctrl+P` / `Cmd+P`). Sustituye el sidebar tradicional.

**Funcionalidades:**

- Búsqueda por nombre de archivo (filtro rápido)
- Búsqueda por texto interno (búsqueda full-text en todos los archivos del proyecto)
- Vista previa de archivo seleccionado con resaltado de sintaxis
- Indicadores de estado Git (cambios, staged, sin seguimiento)

```
┌─────────────────────────────────────────────────────────────┐
│ 🔍 [Buscar archivo o texto interno...]                [✕] │
├─────────────────────────────────────────────────────────────┤
│ 📄 src/auth/jwt.go                                🔴 2    │
│ 📄 src/auth/login.go                                🟡 1    │
│ 📄 src/main.go                                       ✅     │
...
| :---------------- | :-------------------- | :-------------------- |
| **Abrir archivo** | Atajo (ej. Ctrl+P)    | Abre popup explorer   |
...
4. Editor recibe: "agent:highlight" para archivos
     ↓
5. Editor marca archivos (visibles en el popup explorer al activarse)
     ↓
...
| File Explorer Popup | Ctrl+P        | Cmd+P       |
...
│ ←    ←── cursor                                             │
├─────────────────────────────────────────────────────────────┤
│ Ln 11, Col 4 │ UTF-8 │ Go │ git:main ✚2 ─1                 │
└─────────────────────────────────────────────────────────────┘

Nota: El File Explorer ahora es un popup independiente (Ctrl+P / Cmd+P),
no un sidebar permanente. El área de trabajo es continua.
```
