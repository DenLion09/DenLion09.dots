...
El explorador de archivos se ha separado a su propia especificación: **[04b-file-explorer.md](./04b-file-explorer.md)**.

Características principales:

- Popup independiente (Ctrl+P / Cmd+P)
- Búsqueda por nombre y texto interno
...
| :---------------- | :-------------------------------------------------- | :-------------------- |
| **Abrir archivo** | Ver [04b-file-explorer.md](../04b-file-explorer.md) | Abre popup explorer   |
...
4. Editor recibe: "agent:highlight" para archivos
     ↓
5. Editor marca archivos (ver [04b-file-explorer.md](../04b-file-explorer.md) para detalles del popup)
     ↓
...
| File Explorer Popup | Ver [04b-file-explorer.md](../04b-file-explorer.md) | Ver specs   |
...
_Nota: El File Explorer es un popup independiente. Ver [04b-file-explorer.md](./04b-file-explorer.md)._
