...
Es la reduccion de skills combencionales a una distribucion en diferents archivos mas pequeños secmentados segun sea posible para no cargar innecesariamente en contexto con informacion que no se va a utilizar en ese momento
...
5. carga skills de 1000 lineas de codigo para solo utilizar una parte de este
...
5. lazy load de eskills aplicado, solo se carga lo que se necesita
