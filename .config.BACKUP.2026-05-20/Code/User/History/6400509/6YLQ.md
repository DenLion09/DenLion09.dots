...
| :-- | :------------------------ | :--------------------------------- | :------------ | :----------------------------------------------------------- |
| 1   | **Chat IA**               | `specs/03-ui-chat-ia.md`           | ✅ SI         | Interfaz de conversación con el agente Main. Animación Ciri. |
| 2   | **Editor de Código**      | `specs/04-ui-editor-codigo.md`     | ✅ SI         | Editor con LSP, syntax highlighting, autocompletado.         |
| 3   | **Navegador WebView**     | `specs/02-ui-navegador-webview.md` | ✅ SI         | WebView integrado con DevTools y Source Maps reversos.       |
| 4   | **File Explorer**         | `specs/04b-file-explorer.md`       | ✅ SI         | Popup de búsqueda de archivos (Ctrl+P).                      |
| 5   | **UI Contenedor (Shell)** | `specs/01-ui-contenedor-shell.md`  | ❌ NO         | Shell principal, dock, workspace.                            |

### 2.2 Servicios (Backend/Sin UI)

| #   | Servicio                       | Spec                                  | Prioridad MVP | Descripción                                                              |
| :-- | :----------------------------- | :------------------------------------ | :------------ | :----------------------------------------------------------------------- |
| 1   | **Sistema de Memoria Atómica** | `specs/07-sistema-memoria-atomica.md` | ✅ SI         | PostgreSQL + pgvector. Micro-skills, Flush/Reload, skill injection.      |
...
| Tauri scaffold         | Aplicación Tauri base con React + FlyonUI       | ❌ Pendiente |
...
| **Gestor de Tareas**  | Kanban, proyectos, seguimiento de issues.                     |
...
| Feature           | Descripción |
| :---------------- | :---------- | ------ | ----------------------------------------------------------------- |
| **File Explorer** | App         | Editor | Popup independiente (Ctrl+P), búsqueda por nombre/texto, preview. |
...
| **UI Design con IA**       | Propia  | Diseño UI asistido por IA.     |
...
| Fecha      | Cambio                                                                  | Autor |
| :--------- | :---------------------------------------------------------------------- | :---- |
| 2026-05-09 | Spec consolidada. Sistema de fases definido. Inconsistencias resueltas. | —     |
