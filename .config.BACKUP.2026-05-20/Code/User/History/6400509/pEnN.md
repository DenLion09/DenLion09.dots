...
| 1   | **Sistema de Memoria Atómica** |      | ✅ SI         | PostgreSQL + pgvector. Globals rules, Context Bank, Micro-skills Bank. |
| 4   | **File Explorer**              |      | ❌ NO         | navegacion entre archivos.                                             |

### 2.2 Servicios (Backend/Sin UI)

| #   | Servicio                  | Spec | Prioridad MVP                                                                               | Descripción                                                                                      |
| :-- | :------------------------ | :--- | :------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------- |
| 2   | **Headless Guardian**     |      | Aternativa temporal: GGA `https://github.com/Gentleman-Programmin/gentleman-guardian-angel` | Zero Trust Motor: Input/Output Guards, Loop Sentinel, Communication Bus.                         |
| 3   | **Validaciones Chat LLM** |      | ⚠️ PARCIAL                                                                                  | Streaming validation, Delegation Contracts, Context Management. (no implementado en fase de mvp) |
