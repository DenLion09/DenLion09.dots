...
- [x] **OpenCode GUI** (`ai.opencode.opencode`) — Coding agent open-source, multi-model, extensible vía plugins.
...
| ----------- | ------------------------ | --------------------------------- | ---------------------- |
| Terminal    | **Tilix**                | `com.gexperts.Tilix`              | Tiling integrado       |
|             | **Black Box** (KGX)      | `com.raggesilver.BlackBox`        | /default GNOME         |
