...
- **Bloquea** si se intenta usar librerías fuera de e stack seleccionado sin preguntar al usuario
...
Este subsistema se enfoca en la **capa de presentación al usuario** — todo mensaje que el chat muestra debe pasar por aquí. No valida código (eso es Code Guardian), valida lo que el usuario ve.
...
> **Nota:** Este sistema requiere investigación más exhaustiva sobre cómo funcionan los chats para LLMs y debe considerar que **no solo el usuario enviará mensajes al modelo**, sino que el modelo también enviará mensajes proactivos al usuario, actualizaciones de estado, y delegaciones.
