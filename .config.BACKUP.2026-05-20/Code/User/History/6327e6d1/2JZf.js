      ...
      <div className="flex-1 flex flex-col items-start justify-center space-y-4">
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="flex flex-wrap gap-2">
            {/* Contact btn - abre modal con email del owner */}
            <ContactModal ownerEmail={ownerEmail} />

            {/* Download CV btn */}
            <a
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm transition-all hover:opacity-80 cursor-pointer"
              style={{
