...
```
┌─────────────────────────────────────────────────────────┐
│  errors[]  warnings[]  │  RAM: 45MB  │  Agent: IDLE  │  │
└─────────────────────────────────────────────────────────┘
```

- Contador de errores y warnings del workspace activo
- Uso de recursos (RAM)
- Estado del agente Headless Guardian
...
│                                                            │
├────────────────────────────────────────────────────────────┤
│  errors[]  warnings[]  │  RAM: 45MB  │        Agent: IDLE  │  ← Status Bar
└────────────────────────────────────────────────────────────┘
   │          │               │
 Errors/    Resource       Agent Status
 Warnings   Usage          (del Headless Guardian)
```
