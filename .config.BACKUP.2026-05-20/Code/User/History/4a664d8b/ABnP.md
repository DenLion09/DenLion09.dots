...
| Si quieres...                                                                              | Elige                    |
| ------------------------------------------------------------------------------------------ | ------------------------ |
| Máxima velocidad + estética moderna (con GUI, sin terminal)                                | **Hyprland + nwg-shell** |
| Máxima velocidad + estética moderna (tú controlas todo)                                    | **Hyprland vanilla**     |
| instalar y usar en cualquier dispositivo, con GUI, sin tocar terminal para configuraciones | **hyprland**             |

### ¿CachyOS, EndeavourOS o Fedora?

| Aspecto                | CachyOS                                        | EndeavourOS                       | Fedora (NetInstall)              |
| ---------------------- | ---------------------------------------------- | --------------------------------- | -------------------------------- |
