...
| :------------------------------ | :-------------------------------------------------------------------- | :----------- |
| edicion de codio                | edicion de codigo funte con soporte multilenguage                     |              |
...
|                     | Shift+(arow left, arow up, arow down, arow right) mueven el cursor una palabra en la direccion de la flecha |
