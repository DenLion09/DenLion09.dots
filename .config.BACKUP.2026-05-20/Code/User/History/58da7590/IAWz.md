...
│              │  └──────────────────────────┘   │                         │
│              │  ┌──────────────────────────┐   │                         │
│              │  │  In-Memory Cache         │   │ ← Contexto inmediato    │
│              │  │  • Session state         │   │                         │
│              │  │  • Micro-skills active   │   │                         │
│              │  │  • Task queue            │   │                         │
│              │  └──────────────────────────┘   │                         │
...
| In-Memory Cache   | Cache en proceso (Rust) con TTL. Se limpia en cada Context Flush.            |
...
| :----------------- | :-------------------- | :----------------------------------- |
| Chat ↔ Navigator   | URLs, comandos        | Allowlist domains, prompt injection  |
...
La Memoria Atómica se almacena exclusivamente en **PostgreSQL + pgvector**:

| Tecnología                | Propósito                                                                                                                 |
| :------------------------ | :------------------------------------------------------------------------------------------------------------------------ |
| **PostgreSQL + pgvector** | Catálogo global de micro-skills, embeddings vectoriales, historial de ejecuciones, artefactos durables, estado de sesión. |
...
- **Flush:** Persiste FlushHandoffArtifact → actualiza stats → limpia estado en memoria → limpia KV Cache
