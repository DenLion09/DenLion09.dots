...
│              │  └──────────────────────────┘   │                         │
│              │  ┌──────────────────────────┐   │                         │
│              │  │  agente de IA (mmap/NVMe)   │   │ ← Inferencia local      │
│              │  │  •        │   │                         │
│              │  │  • ~4GB VRAM (Q4_K)      │   │                         │
│              │  └──────────────────────────┘   │                         │
│              └──────────────────────────────────┘                         │
...
| Control de versiones | Git + GitKraken/GitUI             | Fase 1     | Parcial (git worktree en specs)                                 |
| Gestión de paquetes  | apt/pacman + npm/pip/go/cargo     | Fase 1     | ❌ Pendiente                                                    |
...
| Herramienta             | Tipo                                    | Prioridad | Estado Spec                        |
| :---------------------- | :-------------------------------------- | :-------- | :--------------------------------- |
| Tests unitarios         | Lenguaje-native (go test, jest, pytest) | Fase 1    | Parcial (Headless Guardian valida) |
...
| **UI Design con IA**   | Implementación propia | Fase 3    | ❌ Pendiente             |
...
│       ├── Chat IA (propia UI + animación Ciri)
...
### **5.3 Optimización de Memoria (target 8-16GB RAM)**

| Estrategia           | Descripción                                                                  |
| :------------------- | :--------------------------------------------------------------------------- |
| **Modelos en disco** | Formato GGUF cuantizado (Q4_K, Q5_K). VRAM de ~14GB a ~4GB.                  |
...
| **Nube opcional**    | Modelo + DB + worktrees en servidor remoto para trabajo desatendido.         |
