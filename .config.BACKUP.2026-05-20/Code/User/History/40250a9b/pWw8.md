...
**Choice**: Interfaz `LLMProvider` con implementaciones concretas para cada proveedor (OpenAI, Anthropic, llama.cpp (autogestionado no en mvp), huggin face serverless inference, mistral)
