...
**Rationale**: El Chat tiene 6 estados bien definidos (per general_specs.md). Zustand ofrece la simplicidad de React Context con mejor rendimiento para actualizaciones frecuentes de streaming. La máquina de estados explícita permite debugging y testing claro.
