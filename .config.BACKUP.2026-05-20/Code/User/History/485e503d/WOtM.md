...
- El modelo puede crear un archivo estracto de la funcionalidad/app (STRACT.md) y la informacion que necesita sin nececidad de gurardarlo en un sistema de memoria y es mas rapido
...
3. Codificacion
   ...
   - el agente autotestea su respuesta
   - combersacion directa con el modelo via audio
   - el cordinador/orquestador puede generar automatizaciones para tareas repetitivas
   - git log como documentacion
