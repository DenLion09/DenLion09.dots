...
A programing language is said to have _Firs-Class functions_ when functions in hat language are trated like any other variable. For axaple in such a language:
