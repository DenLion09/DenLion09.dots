...
while it is most well-knows as the scripting language for a Webs pages, many non-browser environment. Javascript is a _protopype_ based, garbage collected, dynamic language, suporting multiplws paradigms such as imperactive, functional, and object-oriented
