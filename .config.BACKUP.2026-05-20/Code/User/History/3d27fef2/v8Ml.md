...
| **Integración con Guardian** | Toda comunicación validada por Headless Guardian (emporalmente inavilitado)                                    |
...
| **Headless Guardian**          | Input validation, output validation, Loop Sentinel (temporalmente inavilitado) |
...
| Componente            | Integración                                                                           |
| :-------------------- | :------------------------------------------------------------------------------------ |
| **Headless Guardian** | Code Guardian valida lint en tiempo real (debounce 300ms) (temporalmente inavilitado) |
| **File Explorer**     | Popup independiente para apertura de archivos (nueva ventana o nueva tap)             |
...
- [ ] Definir keymaps shortcuts (sistema de modos como nvim pero mas simplificado)
